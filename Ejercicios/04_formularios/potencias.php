...
<body>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        /*
        if($tmp_base != '') {
            if(filter_var($tmp_base, FILTER_VALIDATE_INT) !== FALSE) { // !== para validar que un numero (0 da falso x eso se añade un igual mas)
                $base = $tmp_base;
            } else {
        ...
        */
        ...
        if($tmp_base == '') {
            ...
            /**verifica si $tmp_base es un entero válido. Si es así, ejecuta el bloque de código dentro del if */
